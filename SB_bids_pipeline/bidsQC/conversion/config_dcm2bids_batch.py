...
singularity_image = os.path.join(os.sep, "u", "project", "silvers", "data", "bids", "containers", singularity_image) # Set equal to "NA" if you are running the script locally
...
path_bidsdata = os.path.join(os.sep, "u", "project", "silvers", "data", "bids", "SB_bids_pipeline", "bids_data") # Where the niftis will be put
